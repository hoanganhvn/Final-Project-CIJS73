            ...
            <div className="main-body">
                <div className="main-item row">
                    ...
                    <div className="col-md-8 col-xs-12 col-sm-12">
                        <Link to="/blog/article1" className="margin-bottom" style={{ fontSize: '17px', fontWeight: 400 }}>7 loại giò không thể thiếu trong ngày Tết cổ truyền Việt Nam</Link>
                ...
                <div className="main-item row">
                    <div className="col-md-4 col-xs-12 col-sm-12">
                        <div className="image-zoom">
                        <Link to="/blog/article2"><img src="https://raw.githubusercontent.com/hoanganhvn/Final-Project/master/Trang_Image/blog07_large.jpg" alt="" /></Link>
                        </div>
                    </div>
                    <div className="col-md-8 col-xs-12 col-sm-12">
                        <Link to="/blog/article2" className="margin-bottom" style={{ fontSize: '17px', fontWeight: 400 }}>Nước uống ngon từ rau má, đơn giản và bổ dưỡng</Link>
                        <div className="margin-bottom" style={{ fontSize: '14px', color: '#999' }}>Fresh Organic Food / 30.01.2022</div>
                ...
                <div className="main-item row">
                    <div className="col-md-4 col-xs-12 col-sm-12">
                        <div className="image-zoom">
                            <Link to="/blog/article3"><img src="https://raw.githubusercontent.com/hoanganhvn/Final-Project/master/Trang_Image/blog01_large.jpg" alt="" /></Link>
                        </div>
                    </div>
                    <div className="col-md-8 col-xs-12 col-sm-12">
                        <Link to="/blog/article3" className="margin-bottom" style={{ fontSize: '17px', fontWeight: 400 }}>Công thức món tráng miệng giải ngấy dịp Tết</Link>
                        <div className="margin-bottom" style={{ fontSize: '14px', color: '#999' }}>Fresh Organic Food / 30.01.2022</div>
                ...
                <div className="main-item row">
                    <div className="col-md-4 col-xs-12 col-sm-12">
                        <div className="image-zoom">
                            <Link to="/blog/article4"><img src="https://raw.githubusercontent.com/hoanganhvn/Final-Project/master/Trang_Image/blog02_large.jpg" alt="" /></Link>
                        </div>
                    </div>
                    <div className="col-md-8 col-xs-12 col-sm-12">
                        <Link to="/blog/article4" className="margin-bottom" style={{ fontSize: '17px', fontWeight: 400 }}>Làm báng ngọt kiểu Pháp từ nguyên liệu đơn giản</Link>
                        <div className="margin-bottom" style={{ fontSize: '14px', color: '#999' }}>Fresh Organic Food / 30.01.2022</div>
