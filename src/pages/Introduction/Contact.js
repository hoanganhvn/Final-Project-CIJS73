        ...
        <div id="contact">
          ...
          <div id="policies">
            <p>This site is protected by reCAPTCHA and the Google
              <Link className="google" to="/gioi-thieu/bao-mat">Privacy Policy</Link>
              and
              <Link className="google" to="/gioi-thieu/dich-vu">Terms of Service</Link>
              apply.
            </p>
          </div>
